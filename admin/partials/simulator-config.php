...
// Anciennes options de hero (non utilisées depuis la version pleine page du simulateur)
// Conservées uniquement pour compatibilité, mais plus affichées ni modifiables.
$hero_enabled = 0;
$hero_title = '';
$hero_description = '';
$hero_image = '';
...
jQuery(document).ready(function($) {
    ...
    var mediaUploader;
    // heroMediaUploader supprimé (hero n'est plus utilisé)
