...
(function($) {
    ...
    $(document).ready(function() {
        ...
        console.log('Osmose ADS: Using direct API calls and form POST (no AJAX needed)');
        
        // Plus besoin de vérifier osmoseAds - on utilise directement l'API et des formulaires POST
